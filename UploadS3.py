...
def upload_to_s3(channel, file, region='us-east-1'):
...
def upload_dir_to_s3(bucket, s3_folder, dir_to_upload, region='us-east-1'):
...
def download_dir(s3_folder, local_path, bucket="", region='us-east-1'):
    """
    params:
